...
public class DeckTest {
  ...
  void checkFirstCardInDeck() {
    assertAll("deck",
        () -> assertEquals("What is the first name of the main character in Silent Hill 3?",
            deck.firstCard().getQuestion()),
  ...
  void categoryCardsInVideoGames() {
    assertEquals("[" + card_1.toString()
        + " question= What is the first name of the main character in Silent Hill 3?, answer= heather, category= Video Games]",
